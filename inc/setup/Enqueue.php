...
class Enqueue {
    ...
    public function enqueue(){
        ...
        wp_enqueue_style( 'theme-style', get_template_directory_uri() . '/assets/css/style.min.css', array(), '', 'all' );
        wp_enqueue_script( 'theme-js', get_template_directory_uri() . '/assets/js/main.min.js', array(), '', true );
